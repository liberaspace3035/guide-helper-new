        ...
        <aside class="sidebar" :class="{ 'sidebar-hidden': !sidebarVisible }" role="navigation" aria-label="メインナビゲーション">
            ...
            <nav class="nav">
                <ul class="nav-list">
                    @guest
                        <li>
                            <a href="{{ route('events.index') }}" :aria-current="window.location.pathname.startsWith('/events') ? 'page' : undefined">
                        ...
                        <li>
                            <a href="{{ route('login') }}" :aria-current="window.location.pathname === '/login' ? 'page' : undefined">
                                <svg class="nav-icon" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                        ...
                        <li>
                            <a href="{{ route('register') }}" :aria-current="window.location.pathname === '/register' ? 'page' : undefined">
                                <svg class="nav-icon" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                    ...
                    @auth
                        ...
                        <li>
                            <a href="{{ route('calendar.personal.index') }}" :aria-current="window.location.pathname.startsWith('/calendar/personal') ? 'page' : undefined">
                                <svg class="nav-icon" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                                    <rect x="3" y="4" width="18" height="18" rx="2" ry="2"></rect>
                                    <line x1="16" y1="2" x2="16" y2="6"></line>
                                    <line x1="8" y1="2" x2="8" y2="6"></line>
                        ...
                        @if((auth()->user()->isUser() || auth()->user()->isGuide()) && !auth()->user()->isAdmin())
                        <li>
                            <a href="{{ route('support.index') }}" :aria-current="window.location.pathname === '/support' ? 'page' : undefined">
                                <svg class="nav-icon" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                        ...
                        @if(auth()->user()->isAdmin())
                            <li x-data="{ adminMenuOpen: window.location.pathname.startsWith('/admin') }">
                                ...
                                <ul class="nav-submenu" x-show="adminMenuOpen" x-transition>
                                    ...
                                    <li>
                                        <a href="{{ route('admin.dashboard') }}" :class="{ active: window.location.pathname === '/admin' && window.adminDashboard && window.adminDashboard.activeTab === 'blocks' }" @click.prevent="if (window.adminDashboard) { window.adminDashboard.activeTab = 'blocks'; window.adminDashboard.fetchBlocks(); } else { window.location.href = '{{ route('admin.dashboard') }}'; }">
                                            <svg class="nav-icon" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                                                <circle cx="12" cy="12" r="10"></circle>
